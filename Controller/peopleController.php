...
//      └─────────┘
    public function index() {
        ...
        require($_SERVER['DOCUMENT_ROOT']."/".$_ENV['directory']."/Model/peopleModel.php");
...
//      └────────┘
    public function show($id) {
        ...
        $contactInvoices = get_contactInvoices($id);
...
//      └──────────┘
    public function update($id) {
        ...
        if(isset($_POST['firstname']) AND isset($_POST['lastname']) AND isset($_POST['email'])){
            ...
            $request = $bdd -> prepare('UPDATE people SET firstname = :firstname, lastname = :lastname, email = :email, id = :id WHERE id ='. $id);
...
//      └──────────┘
    public function delete($id) {   
        ...
        if( isset($_POST['del']) ){
            ...
            try{
                require($_SERVER['DOCUMENT_ROOT']."/".$_ENV['directory']."/Model/require.php");
                $request = $bdd -> prepare('DELETE FROM people WHERE id ='. $id);
